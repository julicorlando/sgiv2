...
// Atualiza status para histórico se já passou
$conn->query("
...
$result = $conn->query("SELECT a.*, s.nome as sala_nome, s.local FROM salas_agendamentos a JOIN salas s ON a.sala_id = s.id WHERE a.status = 'ativo' ORDER BY a.data, a.hora_inicio");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        @media print {
            .print-btn, .noprint, .container a { display: none !important; }
            body, .container {
...
<?php include 'includes/menu.php'; ?>
    <div class="container">
        ...
        <a href="agendar_sala.php">Novo Agendamento</a> | <a href="historico_agendamentos.php">Ver Histórico</a>
    </div>
</body>
</html>